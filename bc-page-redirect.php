...
if (version_compare(PHP_VERSION, '7.0', '<')) {
    ...
    add_action('admin_notices', function () {
        ...
        echo esc_html(
            sprintf(
                __('BC Page Redirect plugin requires PHP 7.0 to function properly, but you have version %s installed. The plugin has been auto-deactivated.', 'bc-page-redirect'),
                PHP_VERSION
            )
        );
        echo '</p></div>';
